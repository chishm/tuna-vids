...
#ifndef _AVI_HEADERS_H
#define _AVI_HEADERS_H
...
enum CHUNK_FOURCCS {
	...
	// The following aren't guaranteed to be correct in the AVI file, but should be okay for nearly all normal AVIs
